...
/// @brief Цвет, с учетом прозрачности
...
/// @brief Простая линяя, сост. из двух точек
...
/// @brief Открытая последовательность линий
...
/// @brief Закрытая последовательность линий
